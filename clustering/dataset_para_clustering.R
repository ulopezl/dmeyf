...
palancas$version  <- "dataset-clustering-andrea-SIN-CANARITOS"   #Muy importante, ir cambiando la version
...
TendenciaYmuchomas  <- function( dataset, cols, ventana=6, tendencia=TRUE, minimo=FALSE, maximo=FALSE, promedio=FALSE, 
