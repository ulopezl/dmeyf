...
#La tabla inicial tiene solo el numero de cliente
tabla_prediccion <-  dapply[  , c("numero_de_cliente"), with=FALSE ]
...
for(  i in  1:num_trees ) #genero  num_trees arboles
{
  ...
  tabla_prediccion[  , paste0( "arbol_", i ) := prediccion[, "BAJA+2"] ]
}


#Me fijo que hay en  tabla_prediccion en RStudio
