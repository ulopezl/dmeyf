...
#La idea es hacer arboles mas grandes, de mayor profundidad, y hojas mas pequeñas
#Y promediar 200 de esos arboles  ( y quizas mas )
...
#arbol más profundo, con hojas mas chicas
parametros  <-  list( "cp"=-1, "minsplit"=40,  "minbucket"=5 , "maxdepth"=10 )

num_trees         <- 200    #voy a generar 50 arboles
