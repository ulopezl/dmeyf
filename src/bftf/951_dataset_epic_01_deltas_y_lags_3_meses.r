...
# Experimento 1, son las variables de 3 meses atras. Queremos comparar variable de 3 y 6 meses atras.
# Agregamos las variables nuevas del profe. No están nuestras variables creadas para la compentencia 1.
# 
#limpio la memoria
