...
kscript         <- "961_epic_exp_01_lags_y_deltas_3"

karch_dataset    <- "./datasets/dataset_epic_v951.csv.gz" # EN exp 01 al crear con epic dataset no le cambié el nombre y quedó este.
