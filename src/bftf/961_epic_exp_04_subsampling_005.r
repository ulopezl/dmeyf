...
# Experimento 04 bayesiana para comparar lags 3 meses vs lags 6 meses. Agregamos labda 1 y 2 y maxbin cómo hiperparametros 
#para la bayesiana. 
#limpio la memoria
...
kscript         <- "961_epic_exp_04_subsampling_0.05"

karch_dataset    <- "./datasets/dataset_epic_v951_todas_los_lags_y_deltas.csv.gz" 
...
ktrain_subsampling  <- 0.05   #el undersampling que voy a hacer de los continua, pasamos de 0.1 a 0.05
