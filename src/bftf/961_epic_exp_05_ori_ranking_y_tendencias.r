...
# Experimento 01 bayesiana para comparar lags 3 meses vs lags 6 meses. Agregamos labda 1 y 2 y maxbin cómo hiperparametros 
#para la bayesiana. 
#limpio la memoria
...
kscript         <- "961_epic_exp_05_ori_ranking_y_tendencias"

karch_dataset    <- "/dataset_epic_v951_ori_y_rank_tend.csv.gz" # EN exp 01 al crear con epic dataset no le cambié el nombre y quedó este.
