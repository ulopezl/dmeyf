...
#------------------------------------------------------------------------------
IndicadorMesPandemia <- function(dataset){
  dataset[ , indicador_pandemia := ifelse(foto_mes >= 202003, 1, 0) ]
}

dataset  <- fread( "./datasets/dataset_epic_v951_todas_los_lags_y_deltas.csv.gz")

IndicadorMesPandemia(dataset)
