...
#version nube
nombre_archivo_bo = "E1003_961_epic_exp_02_train_meses_pandemia_BOlog.txt" #poner el nombre del archivo de bo del experimento
...
kgen_mes_hasta   <- 201912  #hasta donde voy a entrenar
kgen_mes_desde   <- 201801  #desde donde voy a entrenar
