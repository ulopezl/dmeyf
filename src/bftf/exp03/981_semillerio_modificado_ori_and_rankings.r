...
#version nube
nombre_archivo_bo = "E1010_961_epic_exp_03_ori_and_rankings_BOlog.txt" #poner el nombre del archivo de bo del experimento
...
karch_dataset   <- "./datasets/dataset_epic_v951_exp3_ori_y_ranking.csv.gz"  #el dataset que voy a utilizar
