...
palancas$version  <- "vidapropia_ori_vars_profe_and_mas_ranked"   #Muy importante, ir cambiando la version
...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[, consumos_cred_diff_mpayroll := (AND_monto_consumos_tarjetas_cred - mpayroll) / mcuentas_saldo ]
