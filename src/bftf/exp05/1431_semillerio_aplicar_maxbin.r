...
karch_dataset  <- "./datasets/dataset_epic_v951_ori_y_rank_tend.csv.gz"
ksalida  <- "semillerio" 
...
x  <- list()
x$gleaf_size   <- 91.646582
x$gnum_leaves  <- 0.523681
x$learning_rate <- 0.197907
x$feature_fraction <- 0.999975
x$max_bin  <- 210
x$num_iterations  <- 3.0
x$pos_ratio  <- 0.003942
