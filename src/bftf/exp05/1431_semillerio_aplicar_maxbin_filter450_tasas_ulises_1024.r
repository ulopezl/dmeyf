...
karch_dataset   <-  "./datasets/canaproxy_vidapropia_01_desde_ori_y_rank_tasas_y_tendymas.csv.gz"
ksalida  <- "semillerio" 
importance_file = './work/impo_vidapropia_01_desde_ori_y_rank_tasas_y_tendymas.txt'

kexperimento  <- 1024
kscript       <- "1421_lgbm_maxbin_variables_tasas_tendymas"
...
x  <- list()
x$gleaf_size   <-  52.06852	
x$gnum_leaves  <-  	0.64002521	
x$learning_rate <- 0.18827843
x$feature_fraction <- 0.5924001	
x$max_bin  <- 211
x$num_iterations  <- 172.9	
x$pos_ratio  <- 0.03595804
