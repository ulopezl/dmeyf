...
## Vamos a comparar las variables de:
## Lags
## Deltas
## Promedios 
## Máximos y minimos
...
## Este código genera el dataset para el control de 6 meses.

## Usamos por default las variables del profesor y eliminamos aquellas que quedan por debajo de la capa geológica de canaritos.
#####################################################################
#limpio la memoria
...
palancas$version  <- "v951_ori_y_rank_tend"   #Muy importante, ir cambiando la version
...
columnas_imp = c('ctrx_quarter','mcaja_ahorro','mtarjeta_visa_consumo','cpayroll_trx','mcuentas_saldo','ctarjeta_visa_transacciones','mpasivos_margen','mv_status01','mpayroll','mprestamos_personales','mcuenta_corriente','mdescubierto_preacordado','foto_mes','mvr_mpagospesos','mactivos_margen')
...
if( palancas$agregartasas){ AgregarTasas }
