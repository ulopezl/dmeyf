...
karch_dataset   <-  "./datasets/canaproxy_vidapropia_01_desde_ori_y_rank_andrea_y_tendymas_version_post_merge_correcto.csv.gz"
ksalida  <- "semillerio" 
...
x  <- list()
x$gleaf_size   <-  46.22197
x$gnum_leaves  <-  0.40937365	
x$learning_rate <- 0.19770516
x$feature_fraction <- 0.1013288
x$max_bin  <- 162
x$num_iterations  <- 194.9
x$pos_ratio  <- 0.03887257
